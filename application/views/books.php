  ...
  <div class="col-sm-3"> 
   <div class="card-1">
      <div class="card-body">
        <div class="row">
            <div class="col-md-12">
				<img src="../../uploads/<?php echo $row->code ?>.jpg" class="img-responsive" style="width:280px;height:260px;cursor:pointer"><br>
			    <div class="category">
			   ...
			   <div class="col-md-12">
				...
				<h6><?php echo $row->author?></h6><br>
				<a href="<?php echo base_url().'index.php/welcome/show/'.$row->sn; ?>" class="btn btn-primary">Edit</a>
				<a href="<?php echo base_url().'index.php/welcome/delete/'.$row->sn; ?>" class="btn btn-danger">delete</a>
				</div>
			 </div>
		  </div>
	   </div>
